...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			<div align="center">
				<form method="post" action="service_notice_writeAction.jsp">
				<table align="center" class="container__table" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input type="text" placeholder="글 제목" name="noticeTitle"></td>
						</tr>
						<tr>
							<td><textarea placeholder="글 내용" name="noticeContent" style="height:350px;width:300px;"></textarea></td>
						</tr>
					</tbody>
			</table>
			<div align="center">
